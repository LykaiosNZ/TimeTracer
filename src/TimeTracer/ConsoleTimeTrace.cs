...
namespace TimeTracer
{
    ...
    /// </summary>
    public class ConsoleTimeTrace : TimeTrace
    {
        ...
        /// <summary>
        /// Initialise a new instance of the <see cref="ConsoleTimeTrace"/> class using the default formatters.
        /// </summary>
        public ConsoleTimeTrace()
            : this(new DefaultMetricFormatter(), new DefaultScopeFormatter())
        {
        }

        /// <summary>
        /// Initialise a new instance of the <see cref="ConsoleTimeTrace"/> class using specified formatters.
        /// </summary>
        ...
        public ConsoleTimeTrace(IMetricFormatter metricFormatter, IScopeFormatter scopeFormatter)
        {
